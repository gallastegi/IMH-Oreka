...
def main() -> None:
    ...
    try:
        ...
        print("No se ha podido leer ir.module.module por permisos.")
        print("No es crÃ­tico para PRC-01. Continuo con ir.model.fields.")
        save_json(
            OUTPUT_DIR / "07_installed_modules_ERROR.json",
            {"error": str(exc)},
        )

    print_section("Descubrimiento de campos candidatos desde ir.model.fields")
    ...
    # En Odoo 12, ir.model.fields suele ser accesible aunque ir.module.module no lo sea.
    ...
    save_json(OUTPUT_DIR / "07_all_ir_model_fields.json", fields)
    save_csv(OUTPUT_DIR / "07_all_ir_model_fields.csv", fields)
    ...
    print_section("Archivos principales generados")
    for name in [
        "07_candidate_ir_models.csv",
        "07_candidate_ir_model_fields.csv",
        "07_installed_modules_ERROR.json",
    ]:
